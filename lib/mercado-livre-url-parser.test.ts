...
test("mantém productId e extrai a oferta de pdp_filters",()=>assert.deepEqual(parseMercadoLivreUrl("https://www.mercadolivre.com.br/produto/p/MLB50181290?pdp_filters=item_id:MLB4345564271"),{catalogDetected:true,productId:"MLB50181290",itemId:"MLB4345564271"}));
test("mantém productId e extrai a oferta de wid",()=>assert.deepEqual(parseMercadoLivreUrl("https://www.mercadolivre.com.br/p/MLB50181290?wid=MLB4345564271"),{catalogDetected:true,productId:"MLB50181290",itemId:"MLB4345564271"}));
