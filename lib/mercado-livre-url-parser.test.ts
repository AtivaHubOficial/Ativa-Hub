...
test("não trata User Product sem oferta explícita como ITEM_ID",()=>assert.throws(()=>parseMercadoLivreUrl("https://www.mercadolivre.com.br/produto/up/MLBU3437902526"),(error:unknown)=>error instanceof MercadoLivreUrlParserError&&error.code==="USER_PRODUCT_UNSUPPORTED"&&error.details?.userProductId==="MLBU3437902526"));
